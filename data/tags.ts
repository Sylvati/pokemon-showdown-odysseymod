...
export const Tags: { [id: IDEntry]: TagData } = {
	...
	bypassprotect: {
		...
		moveFilter: (move) =>
			move.target !== "self" && !("protect" in move.flags),
	},
	nonreflectable: {
		name: "Nonreflectable",
	...
	ou: {
		name: "OU",
		speciesFilter: (species) =>
			species.tier === "OU" || species.tier === "(OU)",
	},
	uubl: {
		name: "UUBL",
	...
	pu: {
		name: "PU",
		speciesFilter: (species) =>
			species.tier === "PU" || species.tier === "(NU)",
	},
	zubl: {
		name: "ZUBL",
	...
	zu: {
		name: "ZU",
		speciesFilter: (species) =>
			species.tier === "(PU)" || species.tier === "ZU",
	},
	nfe: {
		name: "NFE",
	...
	odyag: {
		name: "ODY AG",
		speciesFilter: (species) => species.tier === "ODY AG",
	},
